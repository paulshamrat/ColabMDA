...
```bash
cd /content/drive/MyDrive/openmm
colabmda openmm run --name 4ldj_G12C --replica r1 --total-ns 1.0 --traj-interval 10 --equil-time 100
colabmda openmm merge --pdb-dir simulations/4ldj_G12C/r1 --center --wrap
